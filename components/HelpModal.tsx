                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <section className="bg-yellow-900/10 p-6 rounded-lg border border-yellow-500/20">
                        ...
                        <div className="space-y-6 text-sm text-gray-300">
                            <div>
                                <strong className="text-white block mb-1 text-lg">⚡ Energy Exciter</strong>
                            ...
                            {discoveredMolecules ? (
                                <div>
                                    <strong className="text-white block mb-1 text-lg">𓎤 Magnetic Lasso</strong>
                                    <p>{renderText("Draw a loop around multiple atoms to select them. If the selected ingredients match a known recipe, the Lasso acts as a 'nano-assembler', using force-directed algorithms to fold the atoms into a valid Molecule.")}</p>
                                </div>
                            ) : (
                ...
                <div className="bg-gray-950 border border-gray-700 rounded-xl w-full h-full flex flex-col md:flex-row overflow-hidden shadow-2xl relative">
                    ...
                    <div className="w-full md:w-72 bg-gray-900 border-b md:border-b-0 md:border-r border-gray-800 flex flex-row md:flex-col overflow-x-auto md:overflow-visible no-scrollbar shrink-0">
                        <div className="p-6 hidden md:block border-b border-gray-800">
                            <h3 className="text-2xl font-extrabold text-white flex items-center gap-2 tracking-tight"><span>📘</span> Journal</h3>
                            <p className="text-xs text-gray-500 mt-2 leading-relaxed">Welcome to the SimChem Lab. This journal tracks your scientific progress.</p>
                            <div className="mt-4">
                    ...
                    <div className="flex-1 flex flex-col h-full bg-gray-950 relative min-w-0">
                        ...
                        <div className="p-4 border-t border-gray-800 bg-gray-900/50 flex justify-between items-center md:justify-end">
                            <button onClick={onClose} className="px-8 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg font-bold text-sm transition-colors border border-gray-700 shadow-lg">Close Journal</button>
                        </div>
                    </div>
                </div>
            </div>
