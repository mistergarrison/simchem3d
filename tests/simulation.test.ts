...
import { ELEMENTS, NEUTRON_ELEM, ELECTRON_ELEM, getParticleElementData, SM_PARTICLES } from '../data/elements';
import { MOLECULES } from '../data/molecules';
import { identifyMolecule } from '../engine/utils/molecular';
import { getMoleculeGroup, addAtomToWorld } from '../engine/utils/general';
import { WORLD_SCALE } from '../engine/config';
import { startClearance, CLEARANCE_FRAMES } from '../engine/physics/Clearance';
import { QuantumSystem } from '../engine/physics/nuclear/QuantumSystem';
import { runUnitTests } from './integrity.test';
...
class SystemSuite {
    ...
    async testDeuteriumChain() {
        ...
        // Increase speed to 1000 to ensure high-energy impact for 100% capture probability
        this.shootProjectile('neutron', 1000);
